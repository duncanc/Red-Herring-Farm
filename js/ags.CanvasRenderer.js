...
jQuery(function($) {
    ...
    ags.CanvasRenderer = function(engine, canvas) {
        var renderer = this;
        var mouse = engine.mouse;
        var mouseCursorSprite = new ags.CanvasRenderer.Sprite();
    ...
    ags.CanvasRenderer.prototype = {
        ...
        createFont: function(fontDef, image, number) {
            return new ags.CanvasRenderer.Font(this.engine, fontDef, image, number);
        },
        init: function() {
        },
        ...
        createSprite: function() {
            return new ags.CanvasRenderer.Sprite(this);
        },
        createGUIDisplay: function(gui) {
            var display = new ags.CanvasRenderer.GUIDisplay(gui);
    ...
    ags.CanvasRenderer.Sprite = function(renderer) {
        this.renderer = renderer;
    };
    ags.CanvasRenderer.Sprite.prototype = {
        renderer: null,
        x: 0,
        multX: 0,
        y: 0,
    ...
    ags.CanvasRenderer.detectCompatibility = function() {
        var testCanvas = document.createElement("CANVAS");
        return !!(testCanvas && typeof testCanvas.getContext !== 'undefined');
    };
    
    ags.CanvasRenderer.Font = function(engine, fontDef, image, number) {
    ...
    ags.CanvasRenderer.Font.prototype = $.extend({}, ags.Font.prototype, {
    ...
    ags.CanvasRenderer.GUIDisplay = function(gui) {
        this.gui = gui;
    };
    ags.CanvasRenderer.GUIDisplay.prototype = {
    };
